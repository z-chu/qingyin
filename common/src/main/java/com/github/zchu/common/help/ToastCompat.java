...
final class ToastCompat extends Handler {
    // 当前的吐司对象
    ...
    ToastCompat(Toast toast, WindowManager windowManager) {
        super(Looper.getMainLooper());
        mToast = toast;
        mPackageName = toast.getView().getContext().getPackageName();
        ...
        if (!isShow) {
            ...
            */
            ...
            try {
                ...
                mWindowManager.addView(mToast.getView(), params);
                // 当前已经显示
                isShow = true;
                // 添加一个移除吐司的任务
                sendEmptyMessageDelayed(0, mToast.getDuration() == Toast.LENGTH_LONG ? 2000 : 3500);
